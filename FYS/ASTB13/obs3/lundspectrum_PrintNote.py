...
def gauss_plot(data, gauss_params = []):
    ...
    if gauss_params[0] is None:
        ...
        txtlst = ['---------------------------------------------------------',
                  "Maximum Probable Velocity = " + str(max_vr),
                  "Estimated std for peak 1 = " + str(optim1[2])]
        with open('out.txt', 'a') as output:
            for i in range(0,len(txtlst)):
                output.write(txtlst[i]+'\n')
        ...
        txtlst = ['---------------------------------------------------------',
                  "Maximum Probable Velocity = " + str(max_vr[0]),
                  "Estimated std for peak 1 = " + str(optim2[2]),
                  "Estimated std for peak 2 = " + str(optim2[5])]
        with open('out.txt', 'a') as output:
            for i in range(0,len(txtlst)):
                output.write(txtlst[i]+'\n')
        ...
        txtlst = ['---------------------------------------------------------',
                  "Maximum Probable Velocity = " + str(max_vr[0]),
                  "Estimated std for peak 1 = " + str(optim3[2]),
                  "Estimated std for peak 2 = " + str(optim3[5]),
                  "Estimated std for peak 3 = " + str(optim3[8])]
        with open('out.txt', 'a') as output:
            for i in range(0,len(txtlst)):
                output.write(txtlst[i]+'\n')
        ...
        txtlst = ['---------------------------------------------------------',
                  "Maximum Probable Velocity = " + str(max_vr[0]),
                  "Estimated std for peak 1 = " + str(optim4[2]),
                  "Estimated std for peak 2 = " + str(optim4[5]),
                  "Estimated std for peak 3 = " + str(optim4[8]),
                  "Estimated std for peak 3 = " + str(optim4[11])]
        with open('out.txt', 'a') as output:
            for i in range(0,len(txtlst)):
                output.write(txtlst[i]+'\n')
        ...
        txtlst = ['---------------------------------------------------------',
                  "Maximum Probable Velocity = " + str(max_vr[0]),
                  "Estimated std for peak 1 = " + str(optim5[2]),
                  "Estimated std for peak 2 = " + str(optim5[5]),
                  "Estimated std for peak 3 = " + str(optim5[8]),
                  "Estimated std for peak 3 = " + str(optim5[11]),
                  "Estimated std for peak 3 = " + str(optim5[14])]
        with open('out.txt', 'a') as output:
            for i in range(0,len(txtlst)):
                output.write(txtlst[i]+'\n')
