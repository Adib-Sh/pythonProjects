...
def radial(l,n,Z,plot=True):
    ...
    while nodes != nodes_count or abs(dE) > 1.0e-12:
        #Make sure that the energy is such that the turning point is in the interior of the grid (see figure 5)
        while 1:
